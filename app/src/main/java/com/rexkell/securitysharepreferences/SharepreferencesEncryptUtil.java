package com.rexkell.securitysharepreferences;
...
public class SharepreferencesEncryptUtil {
    ...
    //加密key
    private final static String SIGN_KEY = "RexKell@2016";
    //SHA 加密 ALGORITHM
    ...
    public static SharepreferencesEncryptUtil getInstance(Context context,String signKey) {
        if (instance == null) {
            instance = new SharepreferencesEncryptUtil(context.getApplicationContext(),signKey);
        }
        return instance;
    }
